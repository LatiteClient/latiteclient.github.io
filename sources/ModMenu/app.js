...
//         const bgSizeSlider = document.querySelector(".bgopt");
//         const padSizeSlider = document.querySelector(".padopt");
...
//     const boxWidth = 500; // Adjust the width of the box as needed
//     const boxHeight = 500; // Adjust the height of the box as needed
...
// // Make each draggable box interactive and set random positions
...
// box1.style.left = randomPosition1.x + "px";
// box1.style.top = randomPosition1.y + "px";

// box2.style.left = randomPosition2.x + "px";
// box2.style.top = randomPosition2.y + "px";

// box3.style.left = randomPosition3.x + "px";
// box3.style.top = randomPosition3.y + "px";
